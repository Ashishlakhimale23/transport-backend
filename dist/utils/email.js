...
exports.getDeliveryConfirmationEmailTemplate = exports.getBidApprovalEmailTemplate = exports.sendEmail = void 0;
...
const getBidApprovalEmailTemplate = (bidderName, amount, contractId, startLocation, endLocation, distance, weight, vehicleType) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
exports.getBidApprovalEmailTemplate = getBidApprovalEmailTemplate;
const getDeliveryConfirmationEmailTemplate = (contractorName, contractId, driverName, amount, startLocation, endLocation, distance, weight, vehicleType, notes) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
exports.getDeliveryConfirmationEmailTemplate = getDeliveryConfirmationEmailTemplate;
